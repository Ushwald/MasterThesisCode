...
for i, title in enumerate(titles):
	...
	plt.errorbar(x = alphas, y = plottableData, yerr = stderrs, color = palette[i], linewidth = 2)

plt.plot(analyticdata[0], analyticdata[1], color = palette[len(titles)], linewidth = 2)


plt.legend(['T1000_bigrun', 'T100_bigrun', 'T10_bigrun', 'T1_bigrun', 'Annealed Approximation'])
